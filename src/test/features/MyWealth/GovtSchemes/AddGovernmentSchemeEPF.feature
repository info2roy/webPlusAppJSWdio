Feature: Scripbox MyWealth: Add a Government Scheme "Employee Provident Fund"

  Scenario: As a Scripbox user, I am logged in
    Given I login to Scripbox in "MYSCRIPBOX" for "user180756"

  Scenario Outline: As a logged in user, I am able to add and update a Government Scheme "Employee Provident Fund" to "My Wealth"
    ...
    When I set amount as <amount> for Govt Scheme "Employee Provident Fund"
  ...
  Scenario Outline: From the Government Schemes Page, I can invest and update in "Employee Provident Fund"
    When I select Govt Scheme "Employee Provident Fund" for family member "Investor 156012"
    When I set amount as <amount> for Govt Scheme "Employee Provident Fund"
    When I go back to previous page
    Then Total invested amount should get updated
