Feature: Scripbox Dashboard -> Invest more -> Mutual Funds
  ...
  Scenario Outline: As a logged in user, I am able to do immediate "Core Mutual Fund Portfolio" investment in mutual funds via Every month (SIP)
    ...
    Examples:
      ...
      | Core Mutual Fund Portfolio | Every month (SIP)  | 30000 | Default | Default | Default |  Net Banking | Success |
      | Core Mutual Fund Portfolio | Every month (SIP)  | 1000 | Default | Default | 11 | Net Banking | Success |
      | Core Mutual Fund Portfolio | Every month (SIP)  | 3000 | Default | 1stOfNextMonth | 8 | Net Banking | Success |
      | Core Mutual Fund Portfolio | Every month (SIP)  | 5000 | Default | 5thOfNextToNextMonth | 9 | Net Banking | Success |
      | Core Mutual Fund Portfolio | Every month (SIP)  | 9000 | 60 | Default | Default | Net Banking | Success |
      | Core Mutual Fund Portfolio | Every month (SIP)  | 12000 | 60 | Default | 11 | Net Banking | Success |
      | Core Mutual Fund Portfolio | Every month (SIP)  | 15000 | 60 | 1stOfNextMonth | 8 | Net Banking | Success |
      | Core Mutual Fund Portfolio | Every month (SIP)  | 20000 | 60 | 5thOfNextToNextMonth | 9 | Net Banking | Success |
  ...
  Scenario Outline: As a logged in user, I am able to schedule "Core Mutual Fund Portfolio" investment in mutual funds via One Time Investment
    ...
    Examples:
      ...
      | Core Mutual Fund Portfolio | One time  | 3000 | +2 |
      | Core Mutual Fund Portfolio | One time  | 5000 | 1stOfNextMonth |
      | Core Mutual Fund Portfolio | One time  | 9000 | Default |
      | Core Mutual Fund Portfolio | One time  | 12000 | Default |
  ...
  Scenario Outline: As a logged in user, I am able to do immediate "Core Mutual Fund Portfolio" investment in mutual funds via One Time Investment
    ...
    Examples:
      ...
      | Core Mutual Fund Portfolio | One time  | 30000 | Default | Net Banking | Success |
      | Core Mutual Fund Portfolio | One time  | 1000 | Default | Net Banking | Success |
      | Core Mutual Fund Portfolio | One time  | 3000 | +2 | Net Banking | Success |
      | Core Mutual Fund Portfolio | One time  | 5000 | 1stOfNextMonth | Net Banking | Success |
      | Core Mutual Fund Portfolio | One time  | 9000 | Default | Net Banking | Success |
      | Core Mutual Fund Portfolio | One time  | 12000 | Default | Net Banking | Success |
      | Core Mutual Fund Portfolio | One time  | 15000 | +2 | Net Banking | Success |
      | Core Mutual Fund Portfolio | One time  | 20000 | 1stOfNextMonth | Net Banking | Success |